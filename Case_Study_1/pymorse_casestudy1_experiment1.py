...
#dealing with time = 0
	...
	with Morse("localhost", 4000)  as simu:
		...
		while not esc:
			...
			"14\n" : {"_5\n":[[0.0, 0.785], [0.1, 0.0]], "_6\n": [[0.0, 0.2617], [0.6, 0.0]], "_9\n": [[0.0, 0.785], [0.7, 0.0]], "10\n": [[0.0, 0.5314], [0.6, 0.0]], "13\n": [[0.0, 2.355], [0.6, 0.0]], "15\n": [0.6, 0.0], "26\n": [[0.0, 0.785], [0.1, 0.0]], "27\n": [[0.0, 0.2617], [0.6, 0.0]], "30\n": [[0.0, 0.785], [0.3, 0.0]], "31\n": [[0.0, 0.5314], [0.6, 0.0]], "34\n": [[0.0, 2.355], [0.6, 0.0]], "36\n": [0.2, 0.0], "35\n": [-0.5, 0.0]},
			"_5\n" : {"14\n":[0.0, -0.785], "_6\n": [[0.0, -0.5314], [0.6, 0.0]], "_9\n": [0.6, 0.0], "10\n": [[0.0, -0.2617], [0.6, 0.0]], "13\n": [[0.0, 1.57], [0.6, 0.0]], "15\n": [0.6, 0.0], "27\n": [[0.0, -0.5314], [0.2, 0.0]], "30\n": [0.2, 0.0], "31\n": [[0.0, -0.2617], [0.2, 0.0]], "34\n": [[0.0, 1.57], [0.2, 0.0]], "36\n": [0.0, -0.785], "35\n" :[[0.0, -0.785], [-0.5, 0.0]]},
			"26\n" : {"14\n":[0.0, -0.785], "_6\n": [[0.0, -0.5314], [0.6, 0.0]], "_9\n": [0.6, 0.0], "10\n": [[0.0, -0.2617], [0.6, 0.0]], "13\n": [[0.0, 1.57], [0.6, 0.0]], "15\n": [0.6, 0.0], "27\n": [[0.0, -0.5314], [0.2, 0.0]], "30\n": [0.2, 0.0], "31\n": [[0.0, -0.2617], [0.2, 0.0]], "34\n": [[0.0, 1.57], [0.2, 0.0]], "36\n": [0.0, -0.785], "35\n" :[[0.0, -0.785], [-0.5, 0.0]]},
			"_6\n" : {"_5\n":[[0.0, 0.5314], [0.1, 0.0]], "14\n": [0.0, -0.2617], "_9\n": [[0.0, 0.5314], [0.7, 0.0]], "10\n": [[0.0, 0.2617], [0.6, 0.0]], "13\n": [[0.0, -2.0933], [0.6, 0.0]], "15\n": [[0.0, -0.2617], [0.6, 0.0]], "26\n": [[0.0, 0.5314], [0.1, 0.0]], "27\n": [-0.4, 0.0], "30\n": [[0.0, 0.5314], [0.3, 0.0]], "31\n": [[0.0, 0.2617], [0.2, 0.0]], "34\n": [[0.0, 2.0933], [0.2, 0.0]], "36\n": [[0.0, -0.2617], [0.2, 0.0]], "35\n": [[0.0, -0.2617], [-0.5, 0.0]]},
			"_9\n" : {"_5\n":[-0.6, 0.0], "_6\n": [[0.0, -0.5314], [0.6, 0.0]], "14\n": [0.0, -0.785], "10\n": [[0.0, -0.2617], [0.6, 0.0]], "13\n": [[0.0, 1.57], [0.6, 0.0]], "15\n": [[0.0, -0.785], [0.6, 0.0]], "26\n": [-0.6, 0.0], "27\n": [[0.0, -0.5314], [0.2, 0.0]], "30\n": [-0.4, 0.0], "31\n": [[0.0, -0.2617], [0.2, 0.0]], "34\n": [[0.0, 1.57], [0.2, 0.0]], "36\n": [[0.0, -0.785], [0.2, 0.0]], "35\n": [[0.0, -0.785], [-0.5, 0.0]]},
			"10\n" : {"_5\n":[[0.0, 0.2617], [0.1, 0.0]], "_6\n": [[0.0, -0.2617], [0.6, 0.0]], "_9\n": [[0.0, 0.2617], [0.7, 0.0]], "14\n": [0.0, -0.5314], "13\n": [[0.0, 1.8317], [0.6, 0.0]], "15\n": [[0.0, -0.5314], [0.6, 0.0]], "26\n": [[0.0, 0.2617], [0.1, 0.0]], "27\n": [[0.0, -0.2617], [0.2, 0.0]], "30\n": [[0.0, 0.2617], [0.3, 0.0]], "31\n": [-0.4, 0.0], "34\n": [[0.0, 1.8317], [0.2, 0.0]], "36\n": [[0.0, -0.5314], [0.2, 0.0]], "35\n": [[0.0, -0.5314], [-0.5, 0.0]]}, 
			...
			"27\n" : {"_5\n":[[0.0, 0.5314], [0.1, 0.0]], "_6\n": [0.4, 0.0], "_9\n": [[0.0, 0.5314], [0.7, 0.0]], "10\n": [[0.0, 0.2617], [0.6, 0.0]], "13\n": [[0.0, 2.0933], [0.6, 0.0]], "15\n": [[0.0, -0.2617], [0.6, 0.0]], "26\n": [[0.0, 0.5314], [0.1, 0.0]], "14\n": [0.0, -0.2617], "30\n": [[0.0, 0.5314], [0.3, 0.0]], "31\n": [[0.0, 0.2617], [0.2, 0.0]], "34\n": [[0.0, 2.0933], [0.2, 0.0]], "36\n": [[0.0, -0.2617], [0.2, 0.0]], "35\n": [[0.0, -0.2617], [-0.5, 0.0]]},
			"30\n" : {"_5\n":[-0.2, 0.0], "_6\n": [[0.0, -0.5314], [0.6, 0.0]], "_9\n": [0.4, 0.0], "10\n": [[0.0, -0.2617], [0.2, 0.0]], "13\n": [[0.0, 1.57], [0.6, 0.0]], "15\n": [[0.0, -0.785], [0.6, 0.0]], "26\n": [-0.2, 0.0], "27\n": [[0.0, -0.5314], [0.2, 0.0]], "14\n": [0.0, -0.785], "31\n": [[0.0, -0.2617], [0.2, 0.0]], "34\n": [[0.0, 1.57], [0.2, 0.0]], "36\n": [[0.0, -0.785], [0.2, 0.0]], "35\n": [[0.0, -0.785], [-0.5, 0.0]]},
